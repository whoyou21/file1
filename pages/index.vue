  ...
  <section>
    ...
    <div class="filters row">
      <div class="form-group col-sm-3">
        <label for="search-element">Nama Produk</label>
    ...
    <table class="table">
      ...
      <tr v-for="product in filteredProducts">
        ...
        <td>
          ...
          <nuxt-link class="btn btn-danger btn-xs" :to="{name: 'product-id-delete', params: {id: product.id}}">Hapus</nuxt-link>
        </td>
      </tr>
      </tbody>
    </table>
